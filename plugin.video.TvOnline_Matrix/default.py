...
nome_contador = "TV ONLINE"
link_contador = "https://github.com/perfectsagon/TvOnline"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| TV ONLINE |||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "DESCRIÇÃO ADDON TV ONLINE"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]TV ONLINE[/COLOR] - [COLOR gold](VIP)[/COLOR][/B]"
...
url_origem = 'https://raw.githubusercontent.com/perfectsagon/TvOnline/master/MENU%20PRINCIPAL'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]TV ONLINE[/COLOR][/B]", [
